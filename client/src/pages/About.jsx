                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6">
                        <p className="text-black leading-relaxed text-xl">
                            ...
                            as Firoz Farsan, we have now rebranded as AKBER'S Firoz FARSAN,
                            carrying forward our legacy with a fresh new identity while keeping
                            our authentic flavours unchanged.
                        </p>
                        ...
                        <div>
                            ...
                            <p className="text-black leading-relaxed mb-4 text-xl">
                                ...
                                one of the most iconic spots in Bhendi Bazaar, praised for our
                                delicious farsan and unmatched quality. Customers from across Mumbai
                    ...
                    <div className="space-y-6 order-2">
                        ...
                        <div className="border-2 border-[#7b1315] p-6 rounded-lg mt-8 text-xl">
                            ...
                            <p className="text-center font-medium">
                                "Al Ezz", Ground Floor, Shop No 56,<br />
                                Khara Tank Road, Opp. Al Sadaah,<br />
                                Mumbai 400003.
                            </p>
                        </div>
                    </div>
